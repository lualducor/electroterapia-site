    ...
    >
      <div data-reveal className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="mb-8 md:mb-0 rounded-lg overflow-hidden shadow-xl">
          <Image
            src="/portrait2.webp"
            alt="Dr. Rafael Cortés en su consultorio de electroterapia en Bogotá"
            width={600}
            height={700}
        ...
        <div className="md:pl-8">
          <h3 className="text-cyan-600 dark:text-cyan-400 font-semibold text-lg mb-2">Experiencia</h3>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:ring-offset-2"
          >
