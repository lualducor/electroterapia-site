...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="min-h-[calc(100vh-80px)] flex flex-col-reverse lg:flex-row items-center justify-center px-6 md:px-20 pt-16 pb-20 bg-gradient-to-br from-slate-50 to-cyan-50/40 dark:bg-gray-800 transition-colors duration-300"
    >
      <div className="lg:w-1/2 text-center lg:text-left space-y-6">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-400 px-8 py-3 rounded-lg text-lg font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2"
          >
